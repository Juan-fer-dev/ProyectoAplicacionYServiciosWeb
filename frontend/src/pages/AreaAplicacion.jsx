...
const TABLA = 'area_aplicacion';
const PK    = 'id';
const VACIO = { id: '', nombre: '' };

export default function AreaAplicacion({ readonly = false }) {
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p>Gestión de áreas de aplicación</p>
        </div>
      ...
      {modal && (
        <Modal titulo={modal === 'crear' ? 'Nueva Área de Aplicación' : 'Editar Área de Aplicación'} onClose={cerrarModal}>
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              <label>Nombre</label>
              <input name="nombre" type="text" value={form.nombre} onChange={handleChange} placeholder="Nombre del área" />
            </div>
          </div>
